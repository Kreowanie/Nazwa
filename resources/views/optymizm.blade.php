...
<body>
    ...
    <div class="w-full min-h-[400px] bg-cover bg-center p-5 text-white relative" style="background-image: url('images/city.jpg'); background-color: #575a58; mb-[+20px]">
        <div id="a1" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
         <div class="text-3xl font-bold">  Optymizm polskich pracowników…
            <br/>
    ...
    <div class="mt-5 mx-[25%] mt-10 mb-10"> 
        ...
        <!--    <div class="flex space-x-4 justify-between"> -->
            <!-- Pierwszy blok -->
            <p>
                Polaków nie tylko łatwo o podjęcie pracy, lecz także coraz łatwiej o czerpanie z niej satysfakcji. 
                <span class="font-bold">Bieżącym badaniu po raz pierwszy znaleźliśmy się na podium pośród krajów, w których pracownicy mają najwyższy poziom satysfakcji z wykonywanej pracy</span> – w Polsce sygnalizowało ją 77% badanych, tak jak w Holandii, Norwegii i Luksemburgu. Większy odsetek zadowolonych był tylko w Danii i Austrii (po 79%).
            </p>
            <br/>
            <p>
                Jak komentuje Monika Hryniszyn, Członek Zarządu i Dyrektor Personalna Randstad: – Utrzymujące się zainteresowanie przedsiębiorców otwieraniem nowych miejsc pracy i kurcząca się grupa osób bezrobotnych sprawiają, że 
                <span class="font-bold">firmy coraz bardziej dbają o jakość dostępnych ofert pracy</span>, aby w ogóle pozyskać kandydatów. Oczywiście przede wszystkim rosną wynagrodzenia. Jednak co ważne, coraz więcej firm dba o dodatkowe elementy oferty – zależnie od specyfiki firmy może to być zapewnienie dojazdu do pracy, dostęp do platform samodzielnie wybieranych benefitów, ale też po prostu budowanie przyjaznej atmosfery pracy poprzez różnego typu akcje i działania pro-pracownicze. Wszystkie te elementy przekładają się na widoczną w badaniu Randstad poprawę poczucia satysfakcji z wykonywanej pracy i ogólnego zadowolenia z bycia pracownikiem.
            </p>   
...
<div class="dodajkomentarz">
    <form action="{{ route('optymizmcomments.store') }}" method="POST" class="space-y-4">
