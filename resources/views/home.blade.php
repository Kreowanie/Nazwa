                ...
                <div class="flex space-x-4 justify-between">
                    ...
                    <div class="w-[30%] bg-white p-5 shadow-lg">
                        ...
                        <div class="text-center mt-5 mb-5 font-bold">
                            <h6><a href="dodatek">AGROTURYSTYKA JAKO FORMA BIZNESU</a></h6> <!-- Pogrubienie tytułu -->
                        </div>
                    ...
                    <div class="w-[30%] bg-white p-5 shadow-lg">
                        ...
                        <div class="text-center mt-5 mb-5 font-bold">
                            <h6><a href="pracujesz">Pracujesz w porze nocnej? Sprawdź, w jakiej wysokości przysługuje Ci dodatek!</a></h6> <!-- Pogrubienie tytułu -->
                        </div>
                        <div class="text-center"> 
                    ...
                    <div class="w-[30%] bg-white p-5 shadow-lg">
                        ...
                        <a href="optymizm" class="text-red-500 text-left mt-5  font-bold">BEZ KATEGORII</a>
                          <div class="text-center mt-5 mb-5 font-bold">
                            <h6><a href="optymizm">Optymizm polskich pracowników…</a></h6> <!-- Pogrubienie tytułu -->
                        </div>
                        <div class="text-center"> 
